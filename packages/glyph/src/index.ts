...
export { Table, TableRow, TableHeaderRow, TableCell } from "./components/Table.js";
export type { TableProps, TableRowProps, TableHeaderRowProps, TableCellProps, TableVariant, CellAlign, CellVerticalAlign } from "./components/Table.js";
